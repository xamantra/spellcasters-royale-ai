...
{
    public static void Move(ref NavMeshAgent agent, ref Vector3 currentDestination, ref Transform directionGuide, ref bool directionSelected, Vector3? destination = null)
    {
